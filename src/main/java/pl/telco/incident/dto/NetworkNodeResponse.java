...
@Schema(name = "NetworkNodeResponse", description = "Network node returned by the API.")
public class NetworkNodeResponse {
    ...
    @Schema(description = "Vendor.", example = "Cisco", nullable = true)
    private String vendor;

    @Schema(description = "Whether the node is active.", example = "true")
    private Boolean active;

    @Schema(description = "Creation timestamp.", example = "2026-03-29T07:00:00")
